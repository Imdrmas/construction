...
<div style="background-color: #f5f6f6; padding: 30px 10px 10px; margin-top: -16px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 id="get-qoute-title">Électriques</h2>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumbs">
                    <ol class="breadcrumbs" dir="rtl">
                        ...
                        <li class="breadcrumbs-item active" aria-current="page">électricité</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <section class="content">
                <h2 class="subtitle">Electricité</h2>
                <p>
                    La construction électrique englobe l'ensemble des activités liées à l'installation, la maintenance
                    et la réparation des systèmes électriques dans divers types de bâtiments (résidentiels, commerciaux,
                    industriels). Voici les principales étapes et éléments importants dans ce domaine :
                </p>
                ...
                <img src="images/service/electricity.jpg" class="img-fluid img-thumbnail" alt="...">

                <h3 class="subtitle mt-4">Aperçu du service</h3>
                <p class="paragraph" style="text-align: left;">
                    Dans tous ces aspects, il est crucial d'engager des professionnels qualifiés pour assurer une
                    installation conforme aux standards de sécurité et de performance.
                </p>
                ...
                <h2 class="subtitle mt-3">Installation des Systèmes Électriques</h2>
                <p class="paragraph" style="text-align: left;">
                    Mise en Place des Câblages : Pose des conduits (gainage) et tirage des câbles pour distribuer
                    l'électricité dans tout le bâtiment.
                    Installation des Composants : Montage des prises, interrupteurs, luminaires, appareils électriques,
                    disjoncteurs, etc.
                    Raccordement aux Réseaux : Connexion au réseau électrique principal, mise en place du tableau de
                    distribution.
                </p>
                <hr>
            </section>
                ...
                <ol class="list-group list-group-numbered">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Sécurité Électrique</div>
                            <p class="paragraph">
                            Mise à la Terre : Installation des systèmes de mise à la terre pour éviter les chocs
                            électriques.
                            Protection contre les Surcharges : Installation de disjoncteurs et fusibles pour protéger
                            contre les courts-circuits et les surcharges.
                            Normes et Régulations : Respect des normes locales et internationales en matière de sécurité
                            électrique (comme la NF C 15-100 en France).
                            </p>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Tests et Vérifications</div>
                            <p class="paragraph">
                            Tests de Continuité : Vérification que toutes les connexions sont bien établies.
                            Contrôle des Isolations : Test de l'intégrité des câbles et des isolations.
                            Test de Fonctionnement : Mise sous tension et vérification du bon fonctionnement de tous les
                            systèmes.
                            </p>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Maintenance et Réparation</div>
                            <p class="paragraph">
                            Interventions Préventives : Inspection régulière des installations pour prévenir les pannes.
                            Réparation des Pannes : Dépannage des systèmes électriques en cas de dysfonctionnement.
                            Mise à Niveau : Modernisation des installations pour les rendre conformes aux nouvelles
                            normes ou plus efficaces.
                            </p>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Automatisation et Domotique</div>
                            <p class="paragraph">
                            Systèmes de Contrôle : Installation de systèmes automatisés pour gérer l'éclairage, le
                            chauffage, la sécurité, etc.
                            Intégration des Énergies Renouvelables : Connexion des panneaux solaires ou autres sources
                            d'énergie renouvelable au réseau électrique du bâtiment.
                            </p>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Documentation et Suivi</div>
                            <p class="paragraph">
                            Plan As-Built : Fourniture des plans mis à jour après la construction pour refléter les
                            installations réelles.
                            Manuels d'Utilisation : Documentation des instructions pour l'utilisation et l'entretien des
