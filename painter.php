...
<div style="background-color: #f5f6f6; padding: 30px 10px 10px; margin-top: -16px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 id="get-qoute-title">Peintures intérieur et extérieur</h2>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumbs">
                    <ol class="breadcrumbs" dir="rtl">
                        ...
                        <li class="breadcrumbs-item active" aria-current="page"> Peintures intérieur et extérieur </li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container mt-3 painter">
    <div class="row">

        <div class="col-lg-3 sid-left">
            <div class="card">
                <a href="painter.php">
                    <div class="icon-title-container">
                        <svg xmlns="http://www.w3.org/2000/svg" width="44" height="42" viewBox="0 0 60 60"
                            fill="currentColor">
                            <path
            ...
            <div class="card">
                <a href="electricity.php">
                    <div class="icon-title-container">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="36" height="32" fill="#040960"
            ...
            <div class="box2">
                <h2 class="h2">Avez-vous des questions?</h2>
                <div class="desc">
                    Soumettez une demande commerciale en ligne ou visitez le bureau RMP le plus proche.
                </div>
                <a type="button" class="btn" href="contact.php">
            ...
            <h2 class="subtitle">Temps de travail​</h2>
            <div class="elementor-divider"></div>

            <p class="paragraph" style="text-align: left;">Notre support est disponible pour vous aider 24 heures sur
                24, 7 jours sur 7.</p>
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">
                    ...
                    </svg>Lundi–Vendredi: 08:00–18:00
                </li>
                <li class="list-group-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-clock" viewBox="0 0 16 16">
            ...
            <h2 class="subtitle">Nos brochures​</h2>
            <div class="elementor-divider"></div>
        ...
        <div class="col-lg-9">
            <section class="content">
                <h2 class="subtitle mb-1">Peintures intérieur et extérieur</h2>
                <p class="paragraph mt-2 mb-4">Préparation des surfaces : Avant de peindre, le peintre d'extérieur
                    nettoie les murs (souvent avec un
                    lavage à haute pression), gratte l'ancienne peinture, répare les fissures et applique un apprêt si
                    nécessaire.</p>
                ...
                <img src="images/service/painter.jpg" class="img-fluid" alt="...">

                <h3 class="subtitle mt-4">Aperçu du service</h3>
                <p class="paragraph mt-3" style="text-align: left;">
                    <strong>Application de la peinture</strong>: Utilise généralement des peintures plus résistantes aux
                    intempéries et applique des couches de peinture sur les façades, les volets, les balustrades, et
                    parfois même sur les toits.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Travail en hauteur</strong> : Le peintre d'extérieur doit souvent travailler sur des
                    échafaudages ou des nacelles élévatrices pour atteindre les parties hautes des bâtiments.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Protection contre les éléments</strong> : S'assure que les peintures extérieures protègent
                    efficacement contre la pluie, le vent, le soleil, et les variations de température.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Connaissance des matériaux</strong> : Sélectionne des peintures spécifiquement conçues pour
                    une exposition extérieure, comme celles qui résistent aux UV, à l'humidité, et aux moisissures.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Entretien et restauration</strong> : Peut également effectuer des travaux de restauration,
                    comme la remise en état de façades anciennes ou de monuments historiques.
                </p>
                ...
                <h2 class="subtitle mt-3 mb-3">Détails</h2>
                <p class="paragraph" style="text-align: left;">
                    Que ce soit pour embellir l'intérieur d'une maison ou pour protéger et valoriser l'extérieur d'un
                    bâtiment, les peintres jouent un rôle clé dans l'aspect final et la durabilité des structures.
                </p>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><strong>Précision et attention aux détails</strong></td>
                            <td class="td-desc">Essentiel pour des finitions propres et esthétiques.</td>
                        </tr><br>
                        <tr>
                            <td><strong>Connaissance des matériaux</strong></td>
                            <td class="td-desc">Comprendre les propriétés des différentes peintures et revêtements pour
                                sélectionner le bon produit pour chaque travail.</td>
                        </tr>
                        <tr>
                            <td><strong>Endurance physique</strong></td>
                            <td class="td-desc">Le travail de peintre peut être exigeant physiquement, surtout en
                                extérieur où les conditions météorologiques peuvent varier.</td>
                        </tr>
                        <tr>
                            <td><strong>Sens de l'esthétique</strong></td>
                            <td class="td-desc">Avoir un bon œil pour les couleurs et l'harmonie visuelle est crucial,
                                en particulier pour le conseil et la réalisation de projets décoratifs.</td>
                        </tr>
                        <tr>
                            <td><strong>Contract</strong></td>
                            <td class="td-desc">Reading the contract</td>
                        </tr>
            ...
            <h2 class="subtitle mt-5">Notre liste de prix</h2><br>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card" style="width: 100%;">
                                <div class="card-body">
                                    <h5 class="card-title">Première consultation</h5>
                                    <p class="card-text">Offre spéciale</p>
                                    <div class="price">$100/mo</div>
                                </div>
                            </div>
                            <div class="card" style="width: 100%; border-top:none">
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Analyse d'objet</li>
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Analyse du territoire
                                        </li>
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Sélection des options
                                        </li>
                                        <li class="list-group-item" style="color: #aeb6be;"><i class="bi bi-x"
                                                style="color: #aeb6be;"></i> Discussion détaillée</li>
                                    </ul>
                        ...
                        <div class="col-lg-4">
                            <div class="card" style="width: 100%; background-color: #222931;">
                                <div class="card-body">
                                    <h5 class="card-title" style="color: #ffe718; font-weight: 500;">Project planning
                                    </h5>
                                    <p class="card-text" style="color: #5f656d;">for first-time clients</p>
                                    <div class="price" style="color: #ffe718;">$245/mo</div>
                                </div>
                            </div>
                            <div class="card" style="width: 100%; border-top:none">
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Analyse d'objet</li>
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i>Calculs</li>
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i>Sélection des options
                                        </li>
                                        <li class="list-group-item" style="color: #aeb6be;"><i class="bi bi-x"
                                                style="color: #aeb6be;"></i> Discussion détaillée</li>
                                    </ul>
                                    <a href="contact.php" class="btn">REQUEST A QOUTE</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="card" style="width: 100%;">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">visualization</p>
                            ...
                            <div class="card" style="width: 100%; border-top:none">
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Analyse d'objet</li>
                                        <li class="list-group-item"><i class="bi bi-check-lg"></i> Discussion détaillées
                                        </li>
                                        <li class="list-group-item" style="color: #aeb6be;"><i class="bi bi-x"
                                                style="color: #aeb6be;"></i> Project’s visualization</li>
                                        <li class="list-group-item" style="color: #aeb6be;"><i class="bi bi-x"
                                                style="color: #aeb6be;"></i>Calculs</li>
                                    </ul>
                                    <a href="contact.php" class="btn">REQUEST A QOUTE</a>
                                </div>
                            </div>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body">
                                <p class="paragraph" style="color: #5F656D;">Yes, you can make changes to your floor
                                    plan. We have always allowed our purchasers to customize our plans to meet their
                                    needs. However, all changes must be approved by us to ensure that they will meet
                                    site and structural requirements.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <p class="paragraph" style="color: #5F656D;">
                                    Yes, you can make changes to your floor plan. We have always allowed our purchasers
                                    to customize our plans to meet their needs. However, all changes must be approved by
                                    us to ensure that they will meet site and structural requirements.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <h2 class="subtitle mt-4">Nos projets phares</h2>

            <section class="containers">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="images/consultation/consultation2.jpg" alt="Sample Image" class="image">
                            <div class="text-overlay">Améliorations du stade Sanford</div>
                        </div>
                        <div class="col-lg-6">
                            <img src="images/consultation/consultation3.jpg" alt="Sample Image" class="image">
                            <div class="text-overlay">Améliorations du stade Sanford</div>
                        </div>
                    </div>
                </div>
