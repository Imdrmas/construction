...
<div style="background-color: #f5f6f6; padding: 30px 10px 10px; margin-top: -16px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 id="get-qoute-title">Maçonnerie</h2>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumbs">
                    <ol class="breadcrumbs" dir="rtl">
                        ...
                        <li class="breadcrumbs-item active" aria-current="page">Maçonnerie</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container mt-3 painter">
    ...
    <div class="col-lg-3 sid-left">
            ...
            <p class="paragraph" style="text-align: left;">Notre support est disponible pour vous aider 24 heures sur 24, 7 jours sur 7.</p>
        ...
        <div class="col-lg-9">
            <section class="content">
                <h2 class="subtitle mb-1">Maçonnerie</h2>
                <p class="paragraph mt-2 mb-4">
                    La construction en maçonnerie consiste à assembler des matériaux comme les briques, les blocs, les
                    pierres ou les parpaings avec un liant, généralement du mortier. Elle est utilisée pour construire
                    des murs, des cloisons, des fondations, et parfois des éléments architecturaux plus complexes.
                </p>
                ...
                <img src="images/service/masonry.jpg" class="img-fluid" alt="...">

                <h3 class="subtitle mt-4">Aperçu du service</h3>
                <p class="paragraph mt-3" style="text-align: left;">
                    <strong>Préparation du site :</strong> Niveau du terrain et fondation solide.
                    Traçage des lignes pour les murs.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Pose des fondations :</strong> Creusement des tranchées pour les fondations.
                    Coulage du béton pour une base stable.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Montage des murs :</strong> Application du mortier sur la fondation.
                    Pose des premiers rangs de briques ou de blocs, en s'assurant qu'ils sont de niveau.
                    Continuer à monter les rangs en utilisant un niveau à bulle et un fil à plomb pour garantir
                    l'alignement.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Ouvertures (portes et fenêtres) :</strong> Mise en place des linteaux ou des arches pour
                    soutenir les murs au-dessus des ouvertures.
                    Réalisation des encadrements avec des matériaux spécifiques pour renforcer les structures.
                </p>
                <p class="paragraph" style="text-align: left;">
                    <strong>Finitions :</strong> Rejointement : remplissage des joints entre les briques ou les pierres
                    avec du mortier pour une finition nette.
                    Enduits : application d'un enduit sur les murs pour les protéger et les décorer.
                    Isolation : intégration d'isolants dans les murs ou sur leur surface.
                </p>

                <p class="paragraph" style="text-align: left;">
                    <strong>Toiture :</strong> Installation d'un chaînage supérieur (une ceinture de béton ou de métal)
                    pour renforcer la structure et recevoir la toiture.
                </p>

                <div class="row">
                    <div class="col-lg-6">
                        <img src="images/service/masonry1.jpg" width="100%" style="height:400px"
                            class="img-fluid" alt="...">
                    </div>
                    <div class="col-lg-6">
                        <img src="images/service/masonry2.jpg" width="100%" style="height:400px" class="img-fluid"
                            alt="...">
                    </div>
                </div>
                ...
                <p class="paragraph" style="text-align: left;">
                La maçonnerie est une technique durable, capable de supporter des structures massives et offrant une bonne isolation thermique et acoustique. Cependant, elle nécessite des compétences spécifiques pour assurer la stabilité et la longévité de la construction.
                </p>
