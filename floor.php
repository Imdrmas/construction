...
<div style="background-color: #f5f6f6; padding: 30px 10px 10px; margin-top: -16px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 id="get-qoute-title">Sol souple</h2>
            </div>
            <div class="col-lg-6">
                <nav aria-label="breadcrumbs">
                    <ol class="breadcrumbs" dir="rtl">
                        ...
                        <li class="breadcrumbs-item active" aria-current="page">Sol souple</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <section class="content">
                <h2 class="subtitle">Sol souple</h2>
                <p>
                    Le terme "sol souple" fait référence à un type de revêtement de sol qui est flexible, confortable
                    sous les pieds, et souvent utilisé dans divers environnements comme les gymnases, les écoles, les
                    hôpitaux, et les résidences. Voici quelques types de sols souples couramment utilisés dans la
                    construction :
                </p>
                ...
                <img src="images/service/floor1.jpg" class="img-fluid img-thumbnail" alt="...">

                <h3 class="subtitle mt-4">Aperçu du service</h3>
                <p class="paragraph" style="text-align: left;">
                    Les sols souples sont utilisés dans une variété de contextes, allant des espaces résidentiels aux
                    environnements commerciaux et industriels, en raison de leur polyvalence, de leur confort et de leur
                    durabilité.
                </p>
                    ...
                    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card">
                                    <img src="images/service/floor2.jpg" class="d-block rounded mx-auto w-100"
                                        alt="...">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <img src="images/service/floor3.jpg" class="d-block rounded mx-auto w-100"
                                        alt="...">
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="card">
                                    <img src="images/service/floor4.jpg" class="d-block rounded mx-auto w-100"
                                        alt="...">
                                </div>
                            </div>
                        </div>
                ...
                <h2 class="subtitle mt-3">Installation</h2>
                <p class="paragraph" style="text-align: left;">
                    L'installation de sols souples varie selon le type, mais elle implique généralement une préparation
                    minutieuse de la surface sous-jacente pour garantir une adhérence correcte et une finition lisse.
                    Par exemple, les sols en vinyle peuvent nécessiter un sous-plancher parfaitement plat, tandis que
                    les dalles de moquette peuvent être posées directement sur un sol existant.
                </p>
                <hr>
            </section>
                ...
                <ol class="list-group list-group-numbered">
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Vinyle</div>
                            Vinyle : Disponible en lames, en dalles ou en rouleaux, le vinyle est un choix populaire en
                            raison de sa durabilité, sa résistance à l'eau et sa facilité d'entretien. Il peut imiter
                            l'aspect du bois, de la pierre, ou du carrelage.
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Linoléum</div>
                            Linoléum : Fabriqué à partir de matériaux naturels comme l'huile de lin, le linoléum est
                            apprécié pour sa durabilité et ses propriétés antibactériennes. Il est également écologique
                            et peut durer des décennies avec un bon entretien.
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Moquette</div>
                            Moquette : Bien que moins courante dans les espaces publics en raison des préoccupations
                            d'entretien, la moquette reste un choix populaire pour les résidences et certains espaces
                            commerciaux, offrant confort et isolation sonore.
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Caoutchouc</div>
                            Caoutchouc : Utilisé principalement dans les environnements industriels ou sportifs, le
                            caoutchouc est très résistant aux chocs, à l'eau, et facile à nettoyer. Il est aussi souvent
                            utilisé pour ses propriétés antidérapantes.
                        </div>
                    </li>

                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Liège</div>
                            Liège : Le sol en liège est un autre choix écologique, offrant une surface souple,
                            amortissante, et confortable. Il est naturellement résistant aux moisissures et aux
                            insectes, et offre également une bonne isolation thermique et acoustique.
                        </div>
                    </li>
            ...
            <div class="card mt-4">
                ...
                Avantages des sols souples
                </div>
                <div class="card-body">
                    <blockquote class="blockquote mb-0">
                        <p class="paragraph">
                        Confort : Ils sont souvent plus doux sous les pieds par rapport aux sols durs comme le carrelage ou le bois. 
                        </p>
                        <p class="paragraph">Isolation acoustique : Réduit les bruits de pas, rendant l'espace plus silencieux.</p>
                        <p class="paragraph">Sécurité : Les sols souples sont généralement moins glissants et peuvent offrir une meilleure adhérence.</p>
                        <p class="paragraph">Facilité d'entretien : De nombreux sols souples sont faciles à nettoyer et à entretenir.</p>
                    </blockquote>
                </div>
            </div>
            ...
            <section class="floor">
                <div class="container process">
                    <div class="row">
                        <h2 class="subtitle mt-4">The process</h2>
                        <div class="col-lg-6">
            ...
            <h2 class="subtitle mt-4">Our Featured projects</h2>
